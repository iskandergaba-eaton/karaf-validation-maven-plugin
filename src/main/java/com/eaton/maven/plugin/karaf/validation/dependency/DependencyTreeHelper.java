...
public class DependencyTreeHelper {
    ...
    public DependencyTreeHelper(List<?> repositories, Object session, RepositorySystem repositorySystem, int cacheSize) {
    ...
    public DependencyTreeHelper(List<?> repositories, Object session, RepositorySystem repositorySystem) {
    ...
    public DependencyNode getDependencyTree(MavenProject project) throws MojoExecutionException {
        return getDependencyTree(toArtifact(project.getArtifact()));
    }
    ...
    public boolean isArtifactAFeature(Object artifact) {
        return DependencyTreeHelper.isFeature((Artifact) artifact);
    }
